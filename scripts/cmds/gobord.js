...
onStart:async function({ api, event, args, commandModules, prefix }) {
	...
	if (!question) {
		...
		try {
			...
			api.sendMessage(`An error occurred while processing your request${error}`, event.threadID, event.messageID);
