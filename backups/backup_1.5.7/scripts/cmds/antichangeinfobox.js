...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			antiChangeAvatarAlreadyOn: "Your box chat is currently on anti change group avatar. Please contact the administrator if you need to change your group avatar. 🔒\nAlternatively, you can directly contact the owner of this bot by using the command: 💬\n\n /cs [input your problem].",
			antiChangeNameAlreadyOn: "Your box chat is currently on anti change name. Please contact the administrator if you need to change your group name.🔒\nAlternatively, you can directly contact the owner of this bot by using the command: 💬\n\n /cs [input your problem].",
			antiChangeNicknameAlreadyOn: "Your box chat is currently on anti change nickname. Please contact the administrator if you need to change your nickname.🔒\nAlternatively, you can directly contact the owner of this bot by using the command: 💬\n\n /cs [input your problem].",
			antiChangeThemeAlreadyOn: "Your box chat is currently on anti change theme. Please contact the administrator if you need to change your theme.🔒\nAlternatively, you can directly contact the owner of this bot by using the command: 💬\n\n /cs [input your problem].",
			antiChangeEmojiAlreadyOn: "Your box chat is currently on anti change emoji. Please contact the administrator if you need to change your emoji.🔒\nAlternatively, you can directly contact the owner of this bot by using the command: 💬\n\n /cs [input your problem]."
		}
	},
